...
function EnhancedTableHead(props: EnhancedTableProps) {
    ...
    return (
        <TableHead  className={styles.table_head}>
                <TableCell className={styles.check}  padding="checkbox">
                    <Checkbox   
                ...
                {headCells.map((headCell) => (
                    <div className={styles.table_cell_wrapper}>
                            ...
                            {visibleRows.map((row, index) => {
                                ...
                                return (
                                    <TableRow
                                        ...
                                        sx={{ cursor: 'pointer' }}
                                    >
                                        <TableCell className={styles.table_cell} padding="checkbox">
                                            <Checkbox
                                                color="primary"
